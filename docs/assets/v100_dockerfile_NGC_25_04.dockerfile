# NGC PyTorch 25.04: CUDA 12.8 + torch 2.7, V100 (sm_70) build of SplatAD/neurad-studio.
# Same recipe as blackwell_dockerfile_NGC_25_04.dockerfile but compiled for V100.
...
# neurad-studio runtime deps (custom forks first)
