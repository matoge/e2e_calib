"""Train CalibNetDepth on nuScenes data."""
...
from datasets.nuscenes import NuScenesCalibDataset, collate_nuscenes
...
def main():
    ...
    train_ds = NuScenesCalibDataset(cache, split='train')
    val_ds   = NuScenesCalibDataset(cache, split='val')
