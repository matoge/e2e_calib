...
CFG = dict(
    # ── Experiment ─────────────────────────────────────────────────────────
    name             = "v17_4layer_tempanneal",   # → experiments/v17_4layer_tempanneal/
    ...
    cross_temp       = 0.5,   # final cross-attn temperature
    cross_temp_start = 1.0,   # initial temperature (annealed → cross_temp over training)
    img_size    = 64,
    in_channels = 3,
