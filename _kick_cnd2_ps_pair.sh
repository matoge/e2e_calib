...
infra/submit_clearml_task.sh \
  ...
  --args "--cache /mnt/fsx/tmp/hfunaya/e2e_calib_cache/pandaset_v3_full --pair-mode --epochs 50 --batch-size 32 --img-size 128 --grid-n 16 --oversample 2 --workers 8 --val-fraction 0.1 --n-iter 4 --rot-deg 1.0 --t-m 0.20 --use-info-head --clearml --clearml-project e2e_calib/cross-frame --why \"$WHY\""
